...
SURVEY_STRUCTURE = [   
    ...
    {
        "question": "Bitte bringen Sie die Optionen in die von Ihnen bevorzugte Reihenfolge: Weiter oben bedeutet höhere Priorität. Sie müssen alle Optionen verteilen. Die Auswertung wird am Ende mit der Borda-Score erfolgen (Rang 1 erhält 5 Punkte, Rang 6 erhält 0 Punkte etc.)",
        "type": "prioritization",
        "options": {
    ...
    {
        "question": "Bitte klicken Sie alle Optionen an, die generell infrage kommen. In der Auswertung zählen wir die Anzahl der Auswahlen pro Option.",
